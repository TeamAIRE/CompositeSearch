...
void mergeFiles(int nCpu, string method, string fileOut)
{
	unsigned int i;
	string fileToMerge;
	...
	else
	{
		for( i=0; i < nCpu; i++)
		{
			fileToMerge = to_string(i) + "." + method;
