...
void fastComposites( map<unsigned int, list<unsigned long long int> >& refSubNodes, map<unsigned long long int, geneInfo>& genes, map<pair<unsigned long long int, unsigned long long int>, edgeValues>& edges, unsigned short int MAX_OVERLAP, unsigned int l )
{
	// temporary output file
	string fileOut = to_string(l) + ".fastcomposites";
...
void runFastComposites( map<unsigned long long int, geneInfo>& genes, map<pair<unsigned long long int, unsigned long long int>, edgeValues>& edges, vector<pair<unsigned long long int,unsigned long long int>>& nodesDegree, unsigned short int MAX_OVERLAP, unsigned int nCpu)
{
	...
	{
		threads.push_back(thread(fastComposites, std::ref(refSubList), std::ref(genes), std::ref(edges), MAX_OVERLAP, i));
	}
