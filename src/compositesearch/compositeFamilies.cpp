...
void compositeFamilies( map<unsigned int, list<unsigned long long int> >& familiesToCheck, map<unsigned long long int, geneInfo>& genes, map<unsigned long long int, familyInfo>& geneFamilies, unsigned int l)
{
	string fileOut = to_string(l) + ".compositefamilies";
	ofstream output(fileOut.c_str());
	string fileInfo = to_string(l) + ".compositefamiliesinfo";
...
void runCompositeFamilies( map<unsigned long long int, geneInfo>& genes, map<unsigned long long int, familyInfo>& geneFamilies, unsigned int nCpu)
{
	...
	{
		threads.push_back(thread(compositeFamilies, std::ref(refSubList), std::ref(genes), std::ref(geneFamilies), i));
	}
